        ...
        <div className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-white shadow-md" : "bg-transparent"}`}>
            <div className={`flex justify-between items-center max-w-screen-xl mx-auto px-4 py-3 ${scrolled ? "text-black" : "text-white"}`}>
                ...
                <div className="relative md:hidden">
                    {isOpenMenu ? (
                        <ImCancelCircle className={`text-3xl ${scrolled ? "text-black" : "text-white"}`} onClick={toggleMenu} />
                    ) :
                        (
                            <GiHamburgerMenu className={`text-3xl ${scrolled ? "text-black" : "text-white"}`} onClick={toggleMenu} />
                        )
                    }
